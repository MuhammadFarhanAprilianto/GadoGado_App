...
class _AddMenuScreenState extends State<AddMenuScreen> {
  ...
  String _selectedCategory = AppConstants.categories[1]; // Default to Makanan Utama
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            Text(
              Translator.translate('menu_add_title', authVM.selectedLanguage),
              style: const TextStyle(fontSize: 28, fontWeight: FontWeight.w900, color: Color(0xFF1A1A1A)),
            ),
            const SizedBox(height: 8),
            Text(
              Translator.translate('menu_add_desc', authVM.selectedLanguage),
              ...
              child: ElevatedButton(
                onPressed: _isSaving
                    ...
                    : () async {
                        ...
                        if (_selectedImage == null) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(content: Text(Translator.translate('menu_err_image', authVM.selectedLanguage)))
                          );
                          return;
                        }
                        ...
                        setState(() {
                          _isSaving = true;
                          _loadingText = Translator.translate('menu_status_upload', authVM.selectedLanguage);
                        });
                        ...
                        try {
                          ...
                          // 2. Save Data to Firestore with the Cloud URL
                          setState(() => _loadingText = Translator.translate('menu_status_save', authVM.selectedLanguage));
                          ...
                          final newItem = FoodItemModel(
                            ...
                            image: imageUrl, // Use the new Cloud URL
                          ...
                          await adminVM.addFoodItem(newItem);
                          
                          if (context.mounted) {
                            Navigator.pop(context);
                            ScaffoldMessenger.of(context).showSnackBar(
                              SnackBar(
                                content: Text('${newItem.name} ${Translator.translate('menu_success_cloud', authVM.selectedLanguage)}'),
                ...
                child: _isSaving
                    ? Row(
                     ...
                     : Text(
                        Translator.translate('menu_btn_save', authVM.selectedLanguage),
